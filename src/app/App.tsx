...
const IconMail = ({ color = "currentColor", size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/>
  </svg>
);
const IconPhone = ({ color = "currentColor", size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const IconMapPin = ({ color = "currentColor", size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/>
  </svg>
);
const IconInstagram = ({ color = "currentColor", size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/>
  </svg>
);
const IconTwitter = ({ color = "currentColor", size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function PortfolioPage({ onBack }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "'Georgia', 'Hiragino Mincho ProN', serif", color: C.dark }}>
      ...
      <div style={{ paddingTop: "7rem", padding: "7rem 1.5rem 5rem", maxWidth: 1200, margin: "0 auto" }}>
            ...
            >
              ...
              <div style={{ padding: "1.5rem" }}>
                ...
                <div style={{ marginTop: "1rem", display: "flex", alignItems: "center", gap: "0.4rem", color: C.accent, fontSize: "0.82rem", letterSpacing: "0.1em", opacity: hovered === p.id ? 1 : 0, transition: "opacity 0.3s" }}>
                  <IconExternalLink size={14} /> 詳細を見る
                </div>
              </div>
            </div>
          ))}
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "'Georgia', 'Hiragino Mincho ProN', serif", color: C.dark, overflowX: "hidden" }}>
          ...
          <div className="nav-desktop">
            {navLinks.map(l => (
              <button key={l.id} onClick={() => scrollTo(l.id)}
                style={{ background: "none", border: "none", cursor: "pointer", fontSize: "0.9rem", letterSpacing: "0.12em", color: C.dark, fontFamily: "inherit", transition: "color 0.2s" }}
            ...
            <button onClick={() => scrollTo("contact")}
              style={{ padding: "0.55rem 1.4rem", background: C.primary, color: "#fff", border: "none", cursor: "pointer", letterSpacing: "0.12em", fontSize: "0.88rem", fontFamily: "inherit", transition: "background 0.2s" }}
        ...
        {menuOpen && (
          <div style={{ background: C.bg, borderTop: `1px solid ${C.border}`, padding: "1rem 1.5rem" }}>
            {[...navLinks, { label: "Portfolio", id: "portfolio" }, { label: "お問い合わせ", id: "contact" }].map(l => (
              <button key={l.id}
                onClick={() => l.id === "portfolio" ? (setPage("portfolio"), setMenuOpen(false)) : scrollTo(l.id)}
                style={{ display: "block", width: "100%", textAlign: "left", padding: "0.75rem 0", background: "none", border: "none", cursor: "pointer", fontSize: "1rem", letterSpacing: "0.1em", fontFamily: "inherit", color: C.dark, borderBottom: `1px solid ${C.border}` }}
              >{l.label}</button>
            ))}
          </div>
        )}
      ...
      <section id="hero" style={{ minHeight: "100vh", display: "flex", alignItems: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "8rem 1.5rem 5rem", position: "relative", zIndex: 1, width: "100%" }}>
          <div style={{ maxWidth: 780 }}>
            ...
            {/* Tagline — 3行すべて同じフォントサイズ・同じスタイルで統一 */}
            <div style={{ position: "relative", marginBottom: "2.5rem" }}>
              ...
              <div style={{ borderLeft: `4px solid ${C.accent}`, paddingLeft: "1.2rem", position: "relative" }}>
                {["想いをカタチに", "笑顔をそばに", "繋がりを大切に"].map((line, i) => (
                  <p key={i} style={{
            ...
            <div style={{ paddingLeft: "1.2rem", marginBottom: "2.5rem" }}>
              <p style={{ fontSize: "1rem", color: "#666", lineHeight: 1.9 }}>
                伝統と革新が調和するデザインで、<br />お客様の想いを形にいたします。
              </p>
            </div>
            ...
            <div className="cta-group" style={{ display: "flex", flexWrap: "wrap", gap: "1rem", paddingLeft: "1.2rem" }}>
              <button onClick={() => scrollTo("contact")}
                style={{ padding: "1rem 2rem", background: C.primary, color: "#fff", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: "0.5rem", letterSpacing: "0.12em", fontSize: "0.95rem", fontFamily: "inherit", transition: "background 0.2s", boxShadow: "0 4px 20px rgba(139,79,71,0.3)" }}
                onMouseEnter={e => e.currentTarget.style.background = C.deep}
                onMouseLeave={e => e.currentTarget.style.background = C.primary}
              >ご相談はこちら <IconArrowRight /></button>
              <button onClick={() => scrollTo("works")}
                style={{ padding: "1rem 2rem", background: "transparent", color: C.primary, border: `2px solid ${C.primary}`, cursor: "pointer", letterSpacing: "0.12em", fontSize: "0.95rem", fontFamily: "inherit", transition: "all 0.2s" }}
      ...
      <section id="services" style={{ padding: "5rem 1.5rem", background: C.white, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", bottom: 20, left: 10, width: 140, height: 140, color: C.accent, opacity: 0.06 }}><YagasuriBg /></div>
          ...
          <div className="services-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "2rem" }}>
            {services.map((s, i) => (
              <div key={i}
                ...
                style={{ position: "relative", padding: "2.5rem 2rem", border: `2px solid ${hoveredService === i ? C.accent : C.border}`, background: hoveredService === i ? C.bg : C.white, transition: "all 0.3s", overflow: "hidden", transform: hoveredService === i ? "translateY(-4px)" : "none", boxShadow: hoveredService === i ? "0 12px 32px rgba(0,0,0,0.08)" : "none" }}
              >
                <div style={{ position: "absolute", bottom: -20, right: -20, width: 120, height: 120, color: C.primary, opacity: 0.06 }}><YagasuriBg /></div>
      ...
      <section id="works" style={{ padding: "5rem 1.5rem", background: C.bg, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <div className="works-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "2rem" }}>
            {PORTFOLIO_ITEMS.slice(0, 4).map((w) => (
              <div key={w.id}
                ...
                style={{ position: "relative", height: 280, overflow: "hidden", cursor: "pointer", border: `4px solid ${C.white}`, boxShadow: "0 4px 20px rgba(0,0,0,0.1)", transition: "box-shadow 0.3s" }}
              >
          ...
          <div style={{ textAlign: "center", marginTop: "3rem" }}>
            <button onClick={() => setPage("portfolio")}
              style={{ padding: "1rem 2.5rem", background: "transparent", color: C.primary, border: `2px solid ${C.primary}`, cursor: "pointer", letterSpacing: "0.12em", fontSize: "0.95rem", fontFamily: "inherit", transition: "all 0.2s", display: "inline-flex", alignItems: "center", gap: "0.5rem" }}
              onMouseEnter={e => { e.currentTarget.style.background = C.primary; e.currentTarget.style.color = "#fff"; }}
              onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = C.primary; }}
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative" }}>
          ...
          <div className="about-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "4rem", alignItems: "center" }}>
            <div style={{ borderLeft: `4px solid ${C.accent}`, paddingLeft: "1.5rem" }}>
              <h3 style={{ fontSize: "1.8rem", fontFamily: "serif", fontWeight: 400, lineHeight: 1.8, marginBottom: "1.5rem" }}>
                想いをカタチに、<br />笑顔をそばに、<br />繋がりを大切に
              </h3>
              {[
                "私たちYOICHIは、「想いをカタチに」をモットーに、お客様一人ひとりの想いをデザインとしてカタチにしています。",
                "お客様との出会いは私たちにとって新たな物語の始まりです。それぞれのお客様のビジョンを理解し、共に創造する過程は私たちにとって大きなやりがいです。",
              ...
              <div style={{ background: C.bg, padding: "1.5rem", borderLeft: `2px solid ${C.accent}`, marginTop: "1.5rem" }}>
                {[["会社名","YOICHI"],["設立","2026年"],["代表","横山 真一郎"],["副代表","住谷 永人"]].map(([k,v]) => (
                  <div key={k} style={{ display: "flex", gap: "1rem", marginBottom: "0.6rem", fontSize: "0.95rem" }}>
                    <span style={{ color: C.textMuted, minWidth: 72 }}>{k}</span><span>{v}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ maxWidth: 900, margin: "0 auto 5rem", position: "relative" }}>
            ...
            <div className="origin-card" style={{ background: C.white, border: `1px solid ${C.border}`, padding: "3rem 3rem 3rem 3.5rem", position: "relative", overflow: "hidden" }}>
              {/* 背景装飾 */}
              <div style={{ position: "absolute", top: -30, right: -30, width: 200, height: 200, color: C.primary, opacity: 0.04 }}><YagasuriBg /></div>
              <div style={{ position: "absolute", bottom: -30, right: 60, width: 150, height: 150, color: C.accent, opacity: 0.04 }}><YagasuriBg /></div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
                  <p style={{ fontSize: "1rem", color: "#444", lineHeight: 2.1, fontFamily: "serif" }}>
                    栃木県に、<strong style={{ color: C.dark }}>那須与一</strong>という弓の名手がいました。
                    遠い距離（75m〜77mと言われています）の船の上にある<strong style={{ color: C.dark }}>扇の的</strong>を、
                    見事に打ち抜いたという逸話があります。
                  </p>
                  ...
                  <div className="distance-box" style={{ background: C.bg, border: `1px solid ${C.border}`, borderLeft: `3px solid ${C.accent}`, padding: "1rem 1.5rem", display: "flex", alignItems: "center", gap: "1.5rem" }}>
                    ...
                    <p style={{ fontSize: "0.88rem", color: "#666", lineHeight: 1.8 }}>
                      揺れる船上の小さな扇を、この距離から一射で射抜いた。<br />
                      その精神は、私たちが目指すべき姿そのものです。
                    </p>
                  </div>

                  <p style={{ fontSize: "1rem", color: "#444", lineHeight: 2.1, fontFamily: "serif" }}>
                    弊社は<strong style={{ color: C.dark }}>栃木県発祥の企業</strong>であり、与一のように的を外さない——
                    お客様一人ひとりに<strong style={{ color: C.dark }}>的を得た商品・サービス</strong>をお届けしようという
                    強い想いから、社名を <strong style={{ color: C.accent, letterSpacing: "0.15em" }}>YOICHI</strong> としました。
                  </p>
                </div>
            ...
            {[
              {
                letter: "Y",
                word: "Yume（夢）",
                desc: "お客様の夢やビジョンを共に描き、デザインの力で現実へと近づける存在でありたいという想いを込めています。",
              },
              {
                letter: "O",
                word: "Omoi（想い）",
                desc: "「想いをカタチに」というモットーの根幹。お客様一人ひとりの想いを丁寧に受け取り、形にすることを大切にしています。",
              },
              {
                letter: "I",
                word: "Ito（縁・糸）",
                desc: "人と人、人とデザインを結ぶ縁を大切に。日本の伝統文化における「縁」の概念をブランドの精神に取り入れています。",
              },
              {
                letter: "C",
                word: "Create（創造）",
                desc: "伝統と革新を融合させ、唯一無二の価値を創り出す。お客様とともに新しいものを生み出す創造の喜びを共有します。",
              },
              {
                letter: "H",
                word: "Harmony（調和）",
                desc: "美しさとは調和から生まれる。日本の美意識「和」を現代のデザインに昇華させ、すべての要素が響き合う作品を目指します。",
              },
              {
                letter: "I",
                word: "Ichi（一・市）",
                desc: "「一期一会」の精神で、お客様との出会いを唯一無二のものとして大切にします。すべての出会いが新たな物語の始まりです。",
              },
            ].map((item, i) => (
              <div key={i} className="letter-card" style={{ background: C.white, border: `1px solid ${C.border}`, padding: "2rem", position: "relative", overflow: "hidden", transition: "box-shadow 0.3s" }}
                onMouseEnter={e => e.currentTarget.style.boxShadow = "0 8px 28px rgba(0,0,0,0.08)"}
                onMouseLeave={e => e.currentTarget.style.boxShadow = "none"}
              >
                <div style={{ position: "absolute", bottom: -20, right: -20, width: 100, height: 100, color: C.primary, opacity: 0.05 }}><YagasuriBg /></div>
                {/* 頭文字 */}
          ...
          <div className="summary-box" style={{ background: C.dark, padding: "3rem 2.5rem", position: "relative", overflow: "hidden", maxWidth: 800, margin: "0 auto" }}>
            ...
            <div style={{ position: "relative", textAlign: "center" }}>
              ...
              <p style={{ fontSize: "clamp(1.2rem, 3vw, 1.6rem)", fontFamily: "serif", fontWeight: 400, color: C.bg, lineHeight: 1.9, marginBottom: "1.2rem" }}>
                「YOICHI」とは、<br />
                夢・想い・縁・創造・調和・一期一会。<br />
                六つの言葉が織りなす、私たちの誓いです。
              </p>
      ...
      <section id="sns" style={{ padding: "5rem 1.5rem", background: C.bg, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <p style={{ textAlign: "center", color: C.textMuted, marginBottom: "3rem", lineHeight: 1.9 }}>
          ...
          <div className="sns-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "2rem", maxWidth: 720, margin: "0 auto" }}>
            ...
            <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"
              onMouseEnter={() => setHoveredSns("ig")} onMouseLeave={() => setHoveredSns(null)}
              ...
              <div style={{ background: hoveredSns === "ig" ? "linear-gradient(135deg, #833ab4, #fd1d1d, #fcb045)" : C.white, border: `2px solid ${hoveredSns === "ig" ? "transparent" : C.border}`, padding: "2.5rem 2rem", transition: "all 0.3s", position: "relative", overflow: "hidden", transform: hoveredSns === "ig" ? "translateY(-4px)" : "none", boxShadow: hoveredSns === "ig" ? "0 12px 32px rgba(131,58,180,0.25)" : "none" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1rem" }}>
                  <div style={{ width: 52, height: 52, background: hoveredSns === "ig" ? "rgba(255,255,255,0.2)" : "linear-gradient(135deg, #833ab4, #fd1d1d, #fcb045)", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <IconInstagram color="#fff" size={26} />
                  </div>
                  <div>
                    <div style={{ fontWeight: 700, fontSize: "1.1rem", color: hoveredSns === "ig" ? "#fff" : C.dark }}>Instagram</div>
                ...
                <div style={{ marginTop: "1.2rem", display: "flex", alignItems: "center", gap: "0.4rem", color: hoveredSns === "ig" ? "#fff" : C.accent, fontSize: "0.82rem", letterSpacing: "0.1em" }}>
                  フォローする <IconExternalLink size={13} />
                </div>
              </div>
            </a>
            ...
            <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer"
              onMouseEnter={() => setHoveredSns("x")} onMouseLeave={() => setHoveredSns(null)}
              style={{ textDecoration: "none", display: "block" }}
            >
              <div style={{ background: hoveredSns === "x" ? "#000" : C.white, border: `2px solid ${hoveredSns === "x" ? "#000" : C.border}`, padding: "2.5rem 2rem", transition: "all 0.3s", position: "relative", overflow: "hidden", transform: hoveredSns === "x" ? "translateY(-4px)" : "none", boxShadow: hoveredSns === "x" ? "0 12px 32px rgba(0,0,0,0.2)" : "none" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1rem" }}>
                  <div style={{ width: 52, height: 52, background: hoveredSns === "x" ? "rgba(255,255,255,0.15)" : "#000", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <IconTwitter color="#fff" size={26} />
                  </div>
                  <div>
                    <div style={{ fontWeight: 700, fontSize: "1.1rem", color: hoveredSns === "x" ? "#fff" : C.dark }}>X (Twitter)</div>
      ...
      <section id="contact" style={{ padding: "5rem 1.5rem", background: C.white, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <p style={{ textAlign: "center", color: "#555", maxWidth: 600, margin: "0 auto 3rem", lineHeight: 1.9 }}>
          ...
          <div className="contact-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "3rem" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              ...
              <ContactCard icon={IconMapPin} title="所在地">
            ...
            <div style={{ background: C.bg, padding: "2rem", border: `2px solid ${C.border}`, position: "relative", overflow: "hidden" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1.2rem", position: "relative" }}>
                {[{ label: "お名前", type: "text", ph: "山田 太郎" }, { label: "メールアドレス", type: "email", ph: "example@email.com" }].map(f => (
                  <div key={f.label}>
                    ...
                    <input type={f.type} placeholder={f.ph}
                      style={{ width: "100%", padding: "0.75rem 1rem", border: `2px solid ${C.border}`, background: C.white, fontSize: "0.95rem", outline: "none", boxSizing: "border-box", transition: "border-color 0.2s", fontFamily: "inherit" }}
                ...
                <button
                  style={{ padding: "1rem", background: C.primary, color: "#fff", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", letterSpacing: "0.12em", fontSize: "0.95rem", fontFamily: "inherit", transition: "background 0.2s" }}
                  onMouseEnter={e => e.currentTarget.style.background = C.deep}
                  onMouseLeave={e => e.currentTarget.style.background = C.primary}
      ...
      <footer style={{ background: C.dark, color: C.bg, padding: "3rem 1.5rem", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", display: "flex", flexDirection: "column", alignItems: "center", gap: "1.5rem" }}>
          ...
          <div className="footer-links" style={{ display: "flex", gap: "2rem", flexWrap: "wrap", justifyContent: "center" }}>
            {[...navLinks, { label: "Portfolio", id: "portfolio" }, { label: "お問い合わせ", id: "contact" }].map(l => (
              l.id === "portfolio"
                ? <button key="portfolio" onClick={() => setPage("portfolio")} style={{ background: "none", border: "none", color: "#9ca3af", cursor: "pointer", fontSize: "0.85rem", letterSpacing: "0.12em", fontFamily: "inherit", transition: "color 0.2s" }} onMouseEnter={e => e.currentTarget.style.color = C.accent} onMouseLeave={e => e.currentTarget.style.color = "#9ca3af"}>Portfolio</button>
                : <button key={l.id} onClick={() => scrollTo(l.id)} style={{ background: "none", border: "none", color: "#9ca3af", cursor: "pointer", fontSize: "0.85rem", letterSpacing: "0.12em", fontFamily: "inherit", transition: "color 0.2s" }} onMouseEnter={e => e.currentTarget.style.color = C.accent} onMouseLeave={e => e.currentTarget.style.color = "#9ca3af"}>{l.label}</button>
            ))}
          </div>
          <div style={{ display: "flex", gap: "1rem" }}>
            {[{ href: "https://www.instagram.com/", Icon: IconInstagram }, { href: "https://twitter.com/", Icon: IconTwitter }].map(({ href, Icon }) => (
              <a key={href} href={href} target="_blank" rel="noopener noreferrer"
                style={{ width: 36, height: 36, background: "rgba(255,255,255,0.1)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", transition: "background 0.2s" }}
                onMouseEnter={e => e.currentTarget.style.background = "rgba(255,255,255,0.2)"}
                onMouseLeave={e => e.currentTarget.style.background = "rgba(255,255,255,0.1)"}
              ><Icon color="#fff" size={16} /></a>
            ))}
          </div>
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        @media(max-width:768px){
          ...
          .hero-logo-img{width:72px!important;height:72px!important;}
    ...
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "'Georgia', 'Hiragino Mincho ProN', serif", color: C.dark, overflowX: "hidden" }}>
      ...
      <section id="hero" style={{ minHeight: "100vh", display: "flex", alignItems: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "8rem 1.5rem 5rem", position: "relative", zIndex: 1, width: "100%" }}>
          <div style={{ maxWidth: 780 }}>
            ...
            {/* CTAs */}
            <div style={{ display: "flex", flexWrap: "wrap", gap: "1rem", paddingLeft: "1.2rem" }}>
              <button onClick={() => scrollTo("contact")}
                style={{ padding: "1rem 2rem", background: C.primary, color: "#fff", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: "0.5rem", letterSpacing: "0.12em", fontSize: "0.95rem", fontFamily: "inherit", transition: "background 0.2s", boxShadow: "0 4px 20px rgba(139,79,71,0.3)" }}
                onMouseEnter={e => e.currentTarget.style.background = C.deep}
                onMouseLeave={e => e.currentTarget.style.background = C.primary}
      ...
      <section id="origin" style={{ padding: "5rem 1.5rem", background: C.bg, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ maxWidth: 900, margin: "0 auto 5rem", position: "relative" }}>
            ...
            <div style={{ background: C.white, border: `1px solid ${C.border}`, padding: "3rem 3rem 3rem 3.5rem", position: "relative", overflow: "hidden" }}>
              {/* 背景装飾 */}
              <div style={{ position: "absolute", top: -30, right: -30, width: 200, height: 200, color: C.primary, opacity: 0.04 }}><YagasuriBg /></div>
              <div style={{ position: "absolute", bottom: -30, right: 60, width: 150, height: 150, color: C.accent, opacity: 0.04 }}><YagasuriBg /></div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "2rem" }}>
                  ...
                  <div>
                    <p style={{ fontSize: "0.7rem", color: C.textMuted, letterSpacing: "0.25em", marginBottom: "0.2rem" }}>ORIGIN STORY</p>
                    <h3 style={{ fontSize: "1.4rem", fontFamily: "serif", fontWeight: 400, color: C.dark, letterSpacing: "0.08em" }}>那須与一と、的を外さない精神</h3>
                  </div>
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
                  ...
                  {/* 距離の視覚的強調 */}
                  <div style={{ background: C.bg, border: `1px solid ${C.border}`, borderLeft: `3px solid ${C.accent}`, padding: "1rem 1.5rem", display: "flex", alignItems: "center", gap: "1.5rem" }}>
                    <div style={{ textAlign: "center", flexShrink: 0 }}>
                      <div style={{ fontSize: "2.2rem", fontWeight: 700, color: C.accent, lineHeight: 1, fontFamily: "serif" }}>75<span style={{ fontSize: "1rem" }}>〜</span>77</div>
                      <div style={{ fontSize: "0.75rem", color: C.textMuted, letterSpacing: "0.1em" }}>メートル</div>
                    </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "2rem", marginBottom: "4rem" }}>
            {[
              ...
              <div key={i} style={{ background: C.white, border: `1px solid ${C.border}`, padding: "2rem", position: "relative", overflow: "hidden", transition: "box-shadow 0.3s" }}
                onMouseEnter={e => e.currentTarget.style.boxShadow = "0 8px 28px rgba(0,0,0,0.08)"}
                onMouseLeave={e => e.currentTarget.style.boxShadow = "none"}
              >
                <div style={{ position: "absolute", bottom: -20, right: -20, width: 100, height: 100, color: C.primary, opacity: 0.05 }}><YagasuriBg /></div>
          ...
          {/* 総括メッセージ */}
          <div style={{ background: C.dark, padding: "3rem 2.5rem", position: "relative", overflow: "hidden", maxWidth: 800, margin: "0 auto" }}>
            <div style={{ position: "absolute", inset: 0, color: C.primary, opacity: 0.12 }}><YagasuriBg /></div>
            <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 3, background: `linear-gradient(to right, ${C.accent}, ${C.primary})` }} />
            <div style={{ position: "relative", textAlign: "center" }}>
              <p style={{ fontSize: "0.75rem", color: C.accent, letterSpacing: "0.3em", marginBottom: "1.2rem" }}>NAME MEANING</p>
      ...
      <section id="sns" style={{ padding: "5rem 1.5rem", background: C.bg, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "2rem", maxWidth: 720, margin: "0 auto" }}>
            {/* Instagram */}
            <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"
              onMouseEnter={() => setHoveredSns("ig")} onMouseLeave={() => setHoveredSns(null)}
              style={{ textDecoration: "none", display: "block" }}
      ...
      <style>{`html{scroll-behavior:smooth;}*{box-sizing:border-box;margin:0;padding:0;}::placeholder{color:#aaa;}body{overflow-x:hidden;}`}</style>
    </div>
  );
}
